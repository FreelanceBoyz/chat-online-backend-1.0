...
import { RoomPermissionSchema } from './schemas/room.permission.schema';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([{ name: "RoomPermission", schema: RoomPermissionSchema }]),
  ...
  providers: [RoomService, UserService, RoomResolvers, GqlAuthGuard],
  exports: [RoomService]
})
